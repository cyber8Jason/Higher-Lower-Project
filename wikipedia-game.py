...
def main_menu(user_name):
    ...
    match user_choice1:
        ...
        case "2":
            ...
            print(f"\n\033[1;32mDein HIGHSCORE ist: {HIGHSCORE}\033[0m")  # Beispiel-HIGHSCORE
        ...
        case "3":
            ...
            print("\n\033[1;34mSpielmodi:\033[1;33m\n1. \033[1;34mStandard-Modus:\033[0m\nDer klassische Spielmodus, bei dem du in jeder Runde"
                  ...
                  "übernommen wird.\n--> Drücke 1 oder 2 für den Artikel mit den MEISTEN Aufrufen."
                  ...
                  "\n\033[1;33m3. \033[1;34mZeit-Modus:\033[0m\nEin Modus, bei dem du gegen die Zeit spielst und schnell entscheiden musst."
                  "\n\033[1;33m4. \033[1;34mGeo-Modus:\033[0m\nEin Modus, der sich auf geografische Themen konzentriert."
                  "--> Drücke 1 oder 2 für den Artikel mit den MEISTEN Einwohnern/Fläche."
                  "\n\033[1;33m5. \033[1;34mMultiplayer-Modus:\033[0m \nSpiele gegen Freunde und finde heraus, wer der bessere Spieler ist.\n"
